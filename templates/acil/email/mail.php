                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style='line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;' align='left'>
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td class='col-12' style='line-height: 24px; font-size: 16px; min-height: 1px; font-weight: normal; padding-right: 24px; width: 100%; margin: 0;' align='left' valign='top'>
                                                              <center>
                                                                <img class='img-fluid' src='https://aleman-maniobras.github.io/logisticas-integrales/images/logo.png' style='height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; max-width: 100%; width: 100%; border-style: none; border-width: 0;' width='100%'>
                                                              </center>
                                                            </td>
                                                          </tr>
                                                        </tbody>
                                                    ...
                                                    <p class='' style='line-height: 24px; font-size: 16px; width: 100%; margin: 0;' align='left'>Estimado/a: <strong>$nombre</strong></p>
                                                    ...
                                                    <p class='text-gray-700' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='left'>Es un placer para m&#237; compartirle la cotizaci&#243;n que solicit&#243; recientemente. Adjunto a este correo encontrar&#225; todos los detalles y costos relacionados con el servicio que nos requiri&#243;.</p>
                                                    <br>
                                                    <p class='text-gray-700' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='left'>Por favor, revise la informaci&#243;n y no dude en ponerse en contacto conmigo si tiene alguna pregunta adicional. Estoy aqu&#237; para asistirle y garantizar que todas sus necesidades sean atendidas de manera eficiente.</p>
                                                    <table class='s-5 w-full' role='presentation' border='0' cellpadding='0' cellspacing='0' style='width: 100%;' width='100%'>
                                                      <tbody>
                                                        <tr>
                                                          <td style='line-height: 20px; font-size: 20px; width: 100%; height: 20px; margin: 0;' align='left' width='100%' height='20'>
                                                    ...
                                                    <div>
                                                      <p class='text-gray-700 text-center' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='center'><strong>ATENTAMENTE</strong></p>
                                                      ...
                                                      <p class='text-gray-700 text-center' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='center'>Francisco J. Manjarrez Gonz&#225;lez</p>
                                                    </div>
                                                  </td>
                                                </tr>
                                              </tbody>
